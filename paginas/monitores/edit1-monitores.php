...
if (mysqli_num_rows($rs) == 0) {
    ...
    $telefoneMonitor = $dados['telefoneMonitor'];
    $deHoraMonitor = $dados['deHoraMonitor'];
    $ateHoraMonitor = $dados['ateHoraMonitor'];
}
...
<div class="container">
    ...
    <body>
        <div class="mt-3">
            <form action="index.php?menuop=edit2-monitores" method="post">
                <div class="mb-3">
